...
# Depth to cm
locT <- locT %>%
  mutate(Depth = Depth * 100)  # Convert depth to cm
...
# Depth
p6 <- create_histogram(locT, "Depth", binwidth = 50, title = "Depth", x_label = "Depth (cm)") + scale_y_continuous(breaks = scales::pretty_breaks(n = 5), limits = c(0, 10))
...
ggsave("SSS_Covariates_Histograms.png", width = 15, height = 10, dpi = 300)
```
